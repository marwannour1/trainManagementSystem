...
# sys.path.append("C:\Users\Marwan Nour\AppData\Local\Programs\Python\Python310\python.exe")
import pyodbc as py
import datetime
...
available_trips_table = ttk.Treeview(
    available_trips_frame, columns=("Start", "Destination", "Date"), show="headings"
)
...
previous_trips_table = ttk.Treeview(
    previous_trips_frame, columns=("Start", "Destination", "Date"), show="headings"
)
