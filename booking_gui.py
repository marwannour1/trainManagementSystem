...
class BookingPage:
    ...
    def setup_gui(self):
        ...
        book_button = tk.Button(
            ...
            command=lambda: self.book_now_action(
                self.date_entry, self.ticket_entry, self.available_seats
            ),
            font=("Arial", 12),
        )
    ...
    def book_now_action(self, date_entry, ticket_count, available_seats):
        BookingController.book_now(date_entry, ticket_count, available_seats)
